...
function Amount(u1,u2,show) {
    ...
    this.powerRepeat = function(v1,v2,v3,v4) {
        if (v1 != 0) {
            var u3 = Math.LOG10E * Math.log(v1) + v2;
            v1 = 1;
            v2 = u3 * v3 * 10 ** v4;
    ...
    this.strictCompare = function(v1,v2) {
        u3 = new Amount(this.u1,this.u2);
        u3.add(-1 * v1,v2);
        if (u3.u1 > 0) {
            return true;
    ...
    this.fixed = function(v1) {
        this.u1 = Number(this.u1.toFixed(v1));
        this.improve();
    }

...
var basic_effect2_11 = new Amount(3,0,"basic_effect2_11");
var basic_effect2_12 = new Amount(2,0,"basic_effect2_12");
var basic_effect2_13 = new Amount(1.5,-1,"basic_effect2_13");
var effect2_11 = new Amount(1,0,"effect2_11");
...
function addLNP() {
    ...
    gainLNP.multiply(effect2_11.u1,effect2_11.u2);
...
function effect() {
    ...
    effect2_11.change(1,0);
    effect2_11.multiplyRepeat(basic_effect2_11.u1,basic_effect2_11.u2,level2_11.u1,level2_11.u2);
...
function showBuy() {
    ...
    if (LNP.compare(5,8) && isResearch1_5 == 0) {
    ...
    if (LNP.compare(1,10) && isResearch1_6 == 0) {

...
function checkAchievement() {
    if (save.upgradeLevel1_1.compare(1,0) && save.achievement1[0] == 0) {
        ...
        setTimeout("newsList.shift();",5000);
    }
